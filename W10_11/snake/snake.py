...
conn = psycopg2.connect(dbname='Lab10', user='postgres', password='260106', host='localhost')
    ...
    while not done:
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN and event.key == pygame.K_i:
                cur.execute(f''' INSERT INTO snake_scores("username", "user_score") VALUES( '{user_name}', '{game.score}'); ''')
